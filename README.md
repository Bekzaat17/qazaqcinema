...
> Перед работой над кодом — [CLAUDE.md](CLAUDE.md) (архитектура, инварианты) и
> [CODESTYLE.md](CODESTYLE.md) (правила написания кода), затем [PLAN.md](PLAN.md) (что осталось).
> Прод — [DEPLOY.md](DEPLOY.md).
