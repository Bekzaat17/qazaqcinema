...
- Перелинковка сверх крошек: врезки «Жаңа түскен»/«Танымал» на хабах (короткие, только на
  первой странице — на второй те же ссылки повторно), ссылки на годы, а на карточке фильма
  год-ссылка и ссылки на подборки без карточек (страница набирает ссылки, а не вес).
