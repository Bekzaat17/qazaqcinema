...
HOLIDAYS: tuple[Holiday, ...] = (
    ...
    Holiday("konstitutsiya", "Конституция күні", Fixed(8, 30)),
    ...
    # ⚠️ Лунные: даты — по объявлению ДУМК. Таблицу пополнять раз в год, иначе
    # поздравления просто не выйдут (пропуск лучше поздравления не в тот день).
    Holiday(
        "oraza-ait",
        "Ораза айт",
        Lunar(((2026, 3, 20), (2027, 3, 9), (2028, 2, 26), (2029, 2, 14), (2030, 2, 4))),
    ),
    Holiday(
        "qurban-ait",
        "Құрбан айт",
        Lunar(((2026, 5, 27), (2027, 5, 17), (2028, 5, 5), (2029, 4, 24), (2030, 4, 13))),
    ),
)
