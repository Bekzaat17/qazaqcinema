...
class Movie:
    ...
    # Наследие широкого баннера. Визард его больше НЕ запрашивает и hero
    ...
    play_count: int = 0                # число просмотров; входит в «Танымал»
    favorites_count: int = 0           # сколько раз добавлен в избранное; тоже в «Танымал»
    # Сериалы: NULL у обоих = обычный самостоятельный фильм. Заполнены
