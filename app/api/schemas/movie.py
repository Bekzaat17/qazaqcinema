...
class ShelfOut(BaseModel):
    """Готовая полка главной: ключ, казахская подпись и фильмы (собрано на бэке)."""
...
class CatalogHomeOut(BaseModel):
    """Агрегат главного экрана: hero + готовые полки. Кэшируется cache-aside.
    ...
    # Hero = фильм дня: первый экран показывает то, что сегодня
...
class MoviePageOut(BaseModel):
    """Страница каталога: срез + метаданные пагинации. file_id так же скрыт."""
